...
{
       0,    67,    67,    70,    71,    75,    76,    80,    81,    85,
      86,    90,    91,    95,    96,   100,   104,   105,   106,   107,
     108,   109,   113,   114,   118,   119,   120,   124,   125,   129,
     130,   132,   133,   134,   138,   139,   143,   144,   148,   152,
...
#line 155 "semantic.y"
                                    {verifica_var_declarada((yyvsp[-5].val).tipo);}
#line 1390 "sint.c"
    break;
...
#line 1396 "sint.c"
  ...
  case 42: /* Exp: Exp '+' Exp  */
#line 160 "semantic.y"
                      {(yyval.node).tipo=retorna_maior_tipo((yyvsp[-2].node).tipo,(yyvsp[0].node).tipo);Add(&(yyval.node), (yyvsp[-2].node), (yyvsp[0].node));}
#line 1402 "sint.c"
    break;

  case 43: /* Exp: Exp '-' Exp  */
#line 161 "semantic.y"
                      {(yyval.node).tipo=retorna_maior_tipo((yyvsp[-2].node).tipo,(yyvsp[0].node).tipo);Sub(&(yyval.node), (yyvsp[-2].node), (yyvsp[0].node));}
#line 1408 "sint.c"
    break;

  case 44: /* Exp: Exp '*' Exp  */
#line 162 "semantic.y"
                      {(yyval.node).tipo=retorna_maior_tipo((yyvsp[-2].node).tipo,(yyvsp[0].node).tipo);Mult(&(yyval.node), (yyvsp[-2].node), (yyvsp[0].node));}
#line 1414 "sint.c"
    break;

  case 45: /* Exp: Exp '/' Exp  */
#line 163 "semantic.y"
                      {(yyval.node).tipo=retorna_maior_tipo((yyvsp[-2].node).tipo,(yyvsp[0].node).tipo);Div(&(yyval.node), (yyvsp[-2].node), (yyvsp[0].node));}
#line 1420 "sint.c"
    break;
...
#line 1486 "sint.c"
  ...
  case 57: /* Exp: ID '[' NUM ']'  */
#line 175 "semantic.y"
                         {verifica_var_declarada((yyvsp[-3].val).tipo);}
#line 1492 "sint.c"
    break;

  case 58: /* Exp: ID  */
#line 176 "semantic.y"
              {verifica_var_declarada((yyvsp[0].val).tipo);}
#line 1498 "sint.c"
    break;
...
void verifica_var_declarada(int tipo){
	if(tipo==CHAR || tipo==INT || tipo==FLOAT){
		...
		sprintf("Uso de variável não declarada na linha %d\n",linha)
	}
}
